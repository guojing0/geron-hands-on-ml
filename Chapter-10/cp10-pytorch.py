...
@app.cell
def _(TensorDataset, covtype, torch):
    # Normalization
...
@app.cell
def _(DataLoader, covtype_dataset, torch):
    # Dataloader
    ...
    return covtype_test_loader, covtype_train_loader, covtype_valid_loader
...
def _(nn):
    ...
    return (CovtypeClassifier,)


@app.cell
def _(
    CovtypeClassifier,
    covtype_train_loader,
    covtype_valid_loader,
    device,
    nn,
    torch,
    torchmetrics,
    ...
    return covtype_model, metric


@app.cell
def _(covtype_model, covtype_test_loader, evaluate_tm, metric):
